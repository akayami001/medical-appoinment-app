    ...
    <div className="h-full">
      ...
      <section className="bg-white lg:mx-40">
        ...
        />
              ...
              Welcome to our health clinic, where your well-being is our priority.
              </p>
              <div>
          ...
          <main className="flex items-center justify-center px-8 py-8 sm:px-12 lg:col-span-7 lg:px-16 lg:py-12 xl:col-span-6">
            <div className="max-w-xl lg:max-w-3xl">
              ...
              <div className="rounded-lg bg-white p-8 shadow-lg lg:col-span-3 lg:p-12">
                <h2 className="lg:my-20 text-xl">Contact Form</h2>
                  ...
                  <div className="grid grid-cols-1 gap-4 text-center sm:grid-cols-3">
                    <div>
                      ...
                      >
                        ...
                        <span className="text-sm"> Hair T. </span>
                      </label>
                    </div>
                    ...
                    <div>
                      ...
                      >
                        ...
                        <span className="text-sm"> Dental C. </span>
                      </label>
                    </div>
                    ...
                    <div>
                      ...
                      >
                        ...
                        <span className="text-sm"> Plastic S. </span>
                      </label>
                    </div>
                  </div>
